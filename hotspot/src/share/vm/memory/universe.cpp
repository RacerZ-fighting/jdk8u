...
bool universe_post_init()
{
  ...
  Method *m = InstanceKlass::cast(SystemDictionary::Finalizer_klass())->find_method(vmSymbols::register_method_name(), vmSymbols::register_method_signature());
  ...
  m = InstanceKlass::cast(SystemDictionary::misc_Unsafe_klass())->find_method(vmSymbols::throwIllegalAccessError_name(), vmSymbols::void_method_signature());
  if (m != NULL && !m->is_static())
  {
  ...
  m = InstanceKlass::cast(SystemDictionary::ProtectionDomain_klass())->find_method(vmSymbols::impliesCreateAccessControlContext_name(), vmSymbols::void_boolean_signature());
