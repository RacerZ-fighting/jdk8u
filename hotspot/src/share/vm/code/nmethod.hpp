...
public:
  ...
  bool is_alive() const
  {
    unsigned char s = _state;
    return s == in_use || s == not_entrant;
  }
...
public:
  ...
  bool is_evol_dependent_on(Klass *dependee, int h[], uintptr_t e[], int ne[]);
